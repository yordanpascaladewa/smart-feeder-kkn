...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-100 to-cyan-200 p-4 flex items-center justify-center relative overflow-hidden">
      ...
      <main className="relative z-10 w-full max-w-xl md:max-w-3xl bg-white/50 backdrop-blur-xl rounded-[2rem] shadow-2xl border border-white/40 overflow-hidden">
         <div className="p-6 md:p-10 h-full max-h-[90vh] overflow-y-auto custom-scrollbar">
            ...
            <header className="mb-8 flex justify-between items-center">
                ...
                {/* AREA KANAN: TOMBOL LOGOUT & STATUS */}
                <div className="flex items-center gap-3">
                    ...
                    {/* Indikator Online (Hidden di HP kecil biar ga sempit) */}
            ...
            <div className="space-y-4">
                ...
                <Link href="/alat/Sekat%201">
                    <div className="group bg-white/70 hover:bg-white/90 transition-all duration-300 p-4 rounded-2xl shadow-sm border border-emerald-100 cursor-pointer flex items-center justify-between hover:scale-[1.01] hover:shadow-md">
                        <div className="flex items-center gap-3">
                 ...
                 {/* === SEKAT 2 (OFFLINE - ABU ABU) === */}
                 <div className="opacity-60 bg-gray-50 p-4 rounded-2xl border border-gray-100 flex items-center justify-between grayscale cursor-not-allowed">
                        <div className="flex items-center gap-3">
                        ...
                        <span className="px-2 py-1 bg-gray-200 text-gray-400 text-[9px] font-bold rounded-md uppercase tracking-wider">Offline</span>
                </div>

                {/* === SEKAT 3 (OFFLINE - ABU ABU) === */}
                 <div className="opacity-60 bg-gray-50 p-4 rounded-2xl border border-gray-100 flex items-center justify-between grayscale cursor-not-allowed">
                        <div className="flex items-center gap-3">
                            <div className="bg-gray-200 p-2.5 rounded-xl text-gray-400">
                               <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg>
